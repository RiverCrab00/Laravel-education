...
<div style="height:30px; background-color: peru;">{{$errors->first('errorinfo')}}</div>
@endif

  @if($errors->first('username'))
    <div style="height:30px; background-color: peru;">{{$errors->first('username')}}</div>
  @endif
  @if($errors->first('password'))
    <div style="height:30px; background-color: peru;">{{$errors->first('password')}}</div>
  @endif
  @if($errors->first('verify_code'))
    <div style="height:30px; background-color: peru;">{{$errors->first('verify_code')}}</div>
  @endif
